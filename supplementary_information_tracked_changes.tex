...
\textcolor{blue}{The substantially stronger effect sizes on off-road terrain ($r = 0.512$--$0.880$) compared to paved roads ($r = 0.145$--$0.194$) confirm that the framework is most predictive for natural terrain where macro-topographic geometry dominates vehicle excitation.}
